                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="track_expiry" name="track_expiry" value="1" {{ old('track_expiry', $product->track_expiry) ? 'checked' : '' }}
                        ...
                        <div id="expiryFields" class="space-y-3" style="display: none;">
                            <div>
                                ...
                                <select id="expiry_type" name="expiry_type" onchange="toggleExpiryInput()"
                                        class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white">
                                    <option value="date" {{ old('expiry_type', $product->expiry_type ?? 'date') == 'date' ? 'selected' : '' }}>Specific Date</option>
                                    <option value="period" {{ old('expiry_type', $product->expiry_type ?? 'date') == 'period' ? 'selected' : '' }}>Period from Manufacturing</option>
                                </select>
                            </div>
                            ...
                            <div id="expiryPeriodField" style="display: none;">
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input type="number" id="expiry_period" name="expiry_period" value="{{ old('expiry_period', $product->expiry_period) }}" min="1"
                                               class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white">
                                    </div>
                                    <div>
                                        ...
                                        <select id="expiry_period_unit" name="expiry_period_unit"
                                                class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white">
                                            <option value="days" {{ old('expiry_period_unit', $product->expiry_period_unit) == 'days' ? 'selected' : '' }}>Days</option>
                                            <option value="weeks" {{ old('expiry_period_unit', $product->expiry_period_unit) == 'weeks' ? 'selected' : '' }}>Weeks</option>
                                            <option value="months" {{ old('expiry_period_unit', $product->expiry_period_unit) == 'months' ? 'selected' : '' }}>Months</option>
                                            <option value="years" {{ old('expiry_period_unit', $product->expiry_period_unit) == 'years' ? 'selected' : '' }}>Years</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="expiry_alert_days" name="expiry_alert_days" value="{{ old('expiry_alert_days', $product->expiry_alert_days ?? 30) }}" min="1"
                                       class="block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:text-white"
                                       placeholder="30">
